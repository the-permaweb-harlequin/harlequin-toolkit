...
func (s *RemoteSigningServer) HandleWebSocket(c *gin.Context) {
...
func (s *RemoteSigningServer) readWebSocket(client *WebSocketClient) {
	defer func() {
...
func (s *RemoteSigningServer) writeWebSocket(client *WebSocketClient) {
