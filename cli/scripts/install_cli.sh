...
BASE_URL="https://install_cli_harlequin.daemongate.io"
...
for arg in "$@"; do
    case $arg in
        ...
        --help|-h)
            ...
            echo "  VERSION=x.y.z         Same as --version=x.y.z"
            echo "  INSTALL_DIR=/path     Same as --install-dir=/path"
            echo ""
            echo "Examples:"
            echo "  curl -fsSL https://install_cli_harlequin.daemongate.io | sh"
            echo "  curl -fsSL https://install_cli_harlequin.daemongate.io | sh -s -- --dryrun"
